based on the requirements below make an md file of ste by step instruction for creating this platform and be very detailed with the technical requirements, write the clean code as simple as possible (base in mind that this work is a student like work)
...
Caregivers register to the platform with the following information:
a. Name
b. Surname
...
(Family) Members who seek a caregiver also register to the system with the following information:
a. Name
b. Surname
c. Mail address
d. Phone number
...
Family members can search caregivers based on the caregiving type and city.

Family members can post job advertisements to express their need for caregiving. Caregivers can then search through these announcements and apply as needed.
...
Members can view profiles of the potential caregivers that satisfy their conditions. On the profile, they can send a message to the caregiver, or they can allow the caregiver to contact with them.

Members can make an appointment with the caregivers on their profiles.
...
Please stick to Python and SQLAlchemy for Part 3; other frameworks are not allowed.
